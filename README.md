...
## Desenvolvedor Frontend com Paixão por Design
...
Aqui estão os escudos (badges) das tecnologias. Eles são gerados por um serviço chamado Shields.io e funcionam como imagens no Markdown:
